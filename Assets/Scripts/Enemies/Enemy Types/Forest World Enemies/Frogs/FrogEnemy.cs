...
public class FrogEnemy : BaseEnemies
{
    ...
    private bool isOnCooldown = false; // Gibt an, ob der Sprung abk�hlt

    [Header("Attack Settings")]
    public int attackDamage = 2; // Schaden, den der Feind dem Spieler zuf�gt
    ...
    protected override void CheckPlayerPosition()
    {
        ...
        if (isPlayerDetected && distanceToPlayer <= exitRange)
        {
            ...
            // Wenn der Spieler au�erhalb des Detektionsradius, aber innerhalb des Exitradius ist, springt der FrogEnemy zum Rand des Detektionsradius in Richtung des Spielers
            else
            {
                if (!isJumping && !isOnCooldown && !isPreparing)
                {
        ...
        // Wenn der Spieler au�erhalb des Exitradius ist, verliert der FrogEnemy ihn aus den Augen
    ...
    private IEnumerator PrepareAndJump()
    {
        ...
        // Zeige Vorbereitung an (z.B. durch Animation oder visuellen Effekt)
        // TODO: F�gen Sie hier Code f�r die Vorbereitungsanzeige hinzu
    ...
    private IEnumerator PerformJumpAttack()
    {
        ...
        while (elapsedTime < jumpDuration)
        {
            ...
            // Verwende eine Parabel f�r die Sprungh�he
        ...
        // �berpr�fe Kollision mit dem Spieler
    ...
    // �berschreibt die TakeDamage-Methode der Basisklasse
    public override void TakeDamage(int damage, GameObject causer)
    {
        ...
        // Zus�tzliche Logik f�r den FrogEnemy beim Schaden nehmen
    ...
    // �berschreibe die OnDrawGizmosSelected-Methode, um den Angriffsradius und die Zielposition anzuzeigen
